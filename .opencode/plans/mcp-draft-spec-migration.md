...
- **Current verification**: 190/190 package tests across four files; package TypeScript check, ESLint, Prettier, generated declarations, publint, full workspace typecheck, and `git diff --check` all pass.
