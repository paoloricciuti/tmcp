/**
 * @import { OAuthServerProvider, OAuthRegisteredClientsStore } from '../src/internal.js'
 */
...
describe('OAuthProvider', () => {
	...
	describe('Request routing', () => {
		it('returns null for unhandled paths', async () => {
			...
			const response = await oauth_provider.respond(request);
